...
const allPosts = () => {
    ...
    const allCategoriesCourses = JSON.parse(
        window.localStorage.getItem("allCategories")
    );
    ...
    return getAllPosts() //parametro el idUser
        .then((response) => {
            response.forEach((doc) => {
                ...
                const userprueba = allUsers.find(
                    (element) => element.idUser === doc.data().idUser
                );
                const categoryprueba = allCategoriesCourses.find(
                    (element) => element.idCategory == doc.data().idCategory
                );
            ...
            const dataPublic = objectPosts.filter(
                (element) =>
                element.publicPosts == "true" || element.idUser == idUserAuth
            );
            ...
            objectDataPosts.forEach((element) => {
                        ...
                        post.innerHTML = ` 
                            <div class="post-header header">
                                ...
                                <div class="header-right">
                                    <div class="post-category">
                                        ${idUserAuth == element.idUser ? `<img class="btn btn-edit" width="22px" height="22px" data-id="${element.idPost}" src="../../assets/images/svg/edit.png"><img class="btn btn-delete" data-id="${element.idPost}" src="../../assets/images/svg/edit.png">`: ``}
                            ...
                            <div class="post-footer footer">
                                ...
                                <div class="footer-comments comments" id="footer-comments-${element.idPost}"></div>
                            </div>`;
